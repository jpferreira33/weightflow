...
variance 1 – a Gamma of variance 1, i.e. an Exponential(1) (the
Bayesian-bootstrap multiplier): valid and strictly positive, but
right-skewed, which is part of why replicate-to-replicate variance
estimates have heavier tails.
