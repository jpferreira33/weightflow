...
- [From raw sample to final
  weights](https://jpferreira33.github.io/weightflow/dev/articles/quickstart.md):

### Get started

- [Staged survey weighting: the adjustment
  logic](https://jpferreira33.github.io/weightflow/dev/articles/weightflow.md):

### The weighting cascade

- [Preparing the sample: eligibility and response before
  weighting](https://jpferreira33.github.io/weightflow/dev/articles/preparing-the-sample.md):
- [Nonresponse: weighting classes, propensities and
  calibration](https://jpferreira33.github.io/weightflow/dev/articles/nonresponse-propensities.md):
- [Calibration: raking, post-stratification and
  GREG](https://jpferreira33.github.io/weightflow/dev/articles/calibration.md):
- [Ways to specify calibration
  totals](https://jpferreira33.github.io/weightflow/dev/articles/calibration-totals.md):
- [Model calibration (model-assisted
  weighting)](https://jpferreira33.github.io/weightflow/dev/articles/model-calibration.md):
- [Calibrating to a reference
  survey](https://jpferreira33.github.io/weightflow/dev/articles/reference-survey.md):
- [Trimming survey
  weights](https://jpferreira33.github.io/weightflow/dev/articles/trimming.md):
- [Machine learning, cross-fitting and robust
  calibration](https://jpferreira33.github.io/weightflow/dev/articles/advanced-methods.md):
...
- [A full weighting pipeline on a real household survey (ECH
  2019)](https://jpferreira33.github.io/weightflow/dev/articles/ech-case-study.md):
