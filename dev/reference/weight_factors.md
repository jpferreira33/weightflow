...
form of
[`prep()`](https://jpferreira33.github.io/weightflow/dev/reference/prep.md)'s
`$history`, and the starting point for any diagnostic that
[plot()](https://jpferreira33.github.io/weightflow/dev/reference/plot.prepped_weighting_spec.md)
