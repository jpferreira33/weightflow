...
> **Development version.** The cascade shown here is on CRAN. Two conveniences
> used below are development-version only (GitHub): the tidy data-frame
> calibration totals (`count = "Freq"`) and the R-indicator line that
> `summary()` prints after a nonresponse step. Install with
