...
> **Development version.** The tidy data-frame format described here is available
> in the development version of weightflow. The classic `margins`/`totals`
> inputs work in every version and are unchanged.
