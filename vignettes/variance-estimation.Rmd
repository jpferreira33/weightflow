...
> **Development version.** The PSU bootstrap (method 1) and the survey/srvyr
> bridges are on CRAN. The delete-a-PSU **jackknife** (method 3,
> `jackknife_weights()` / `jackknife_estimate()`) is in the development version
> (GitHub) and ships in **0.2.0**. Install with
> `remotes::install_github("jpferreira33/weightflow")` to use it today.
