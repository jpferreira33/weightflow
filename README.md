...
the pre-nonresponse cascade estimates exactly (the two-phase case); and when you
do use a propensity model, it can be fit **unweighted** (`weight_model = FALSE`)
when the weights are unrelated to response given the covariates.
